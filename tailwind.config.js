...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Paleta principal - Slate base con cyan accent
        surface: {
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
      ...
      boxShadow: {
        ...
        'glow-lg': '0 0 35px -5px rgba(6, 182, 212, 0.5)',
      ...
      backgroundImage: {
        ...
        'gradient-mesh-dark':
          'radial-gradient(at 40% 20%, rgba(6, 182, 212, 0.15) 0px, transparent 50%), radial-gradient(at 80% 0%, rgba(16, 185, 129, 0.1) 0px, transparent 50%), radial-gradient(at 0% 50%, rgba(6, 182, 212, 0.08) 0px, transparent 50%)',
        'noise-pattern':
