    ...
    <div class="space-y-4">
      <div class="flex items-center justify-between">
        ...
        <button
          ...
          class="rounded-lg bg-blue-600 px-3 py-1.5 text-sm text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-offset-gray-800"
        >
          + Agregar Enlace
        </button>
      </div>
          ...
          <div class="space-y-3">
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setNewLink({
                    ...newLink(),
                    link_type: e.currentTarget.value as any,
                  })
                }
            ...
            <div>
              ...
              <input
                ...
                value={newLink().title || ''}
                onInput={(e) =>
                  setNewLink({ ...newLink(), title: e.currentTarget.value })
                }
            ...
            <div class="flex space-x-2">
              <button
                ...
                disabled={isLoading()}
                class="flex-1 rounded bg-blue-600 px-3 py-1.5 text-sm text-white hover:bg-blue-700 disabled:opacity-50 dark:bg-blue-500 dark:hover:bg-blue-600"
              >
                {isLoading() ? 'Guardando...' : 'Guardar'}
              </button>
              <button
                onClick={() => setShowAddForm(false)}
                class="flex-1 rounded border border-gray-300 bg-white px-3 py-1.5 text-sm text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
              >
                Cancelar
              </button>
            </div>
            ...
            return (
              <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white p-3 dark:border-gray-700 dark:bg-gray-800">
                <div class="flex flex-1 items-center space-x-3">
                  ...
                  <span
                    class={`inline-flex items-center rounded-full px-2 py-1 text-xs font-medium ${typeInfo.color}`}
                  >
                    {typeInfo.label}
                  </span>
                </div>
                <div class="ml-3 flex items-center space-x-2">
                  <button
                    ...
                    class="rounded p-1.5 text-gray-400 hover:bg-blue-50 hover:text-blue-600 dark:text-gray-500 dark:hover:bg-blue-900/30 dark:hover:text-blue-400"
                    title="Abrir enlace"
                  >
                    <svg
                      class="h-4 w-4"
                  ...
                  <button
                    ...
                    class="rounded p-1.5 text-gray-400 hover:bg-red-50 hover:text-red-600 dark:text-gray-500 dark:hover:bg-red-900/30 dark:hover:text-red-400"
